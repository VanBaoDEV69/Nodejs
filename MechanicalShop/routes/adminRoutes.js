...
router.post('/update-contact/:id', requireAdmin, contactController.updateStatus);
router.get('/message-contact/:id', requireAdmin, contactController.getContactById);
router.post('/message-contact/send-message/:id', requireAdmin, contactController.replyToEmail);
...
router.get('/detail-order/:id', requireAdmin, orderController.getOrderById);
router.post('/edit-order/:id', requireAdmin, orderController.updateOrder);
